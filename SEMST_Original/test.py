...
def main():
    ...
    parser.add_argument('--model_state_path', type=str, default='SEMST_Original_model_state.pth',
    ...
    with torch.no_grad():
        out = model.generate([args.content], [args.style], c_tensor, s_tensor)
