...
def cluster_matching(content_label,
                     style_label,
                     content_cluster_center_norm,
                     style_cluster_center_norm,
                     threshold=0.25):
...
def calc_k(image_path,
    ...
    if not isinstance(device, str) and device.type.startswith('cuda'):
        ...
        cluster_centers_norm = cluster_centers_norm - cluster_centers_norm.min()
        cluster_centers_norm = cluster_centers_norm / cluster_centers_norm.max()
