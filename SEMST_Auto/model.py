...
from feature_transfer import labeled_whiten_and_color, calc_k, cluster_matching
...
class Model(nn.Module):
    ...
    def generate(self,
        ...
        for cp, sp, cf, sf in zip(content_image_path, style_image_path, content_features, style_features):
            content_label, content_center_norm = calc_k(cp, self.kmeans_device)
            style_label, style_center_norm = calc_k(sp, self.kmeans_device)
